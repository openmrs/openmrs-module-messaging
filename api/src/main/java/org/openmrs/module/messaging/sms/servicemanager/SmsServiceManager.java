...
public class SmsServiceManager {
	...
	private List<Modem> detectedModems;
	...
	public SmsServiceManager() {
		...
		detectedModems = new ArrayList<Modem>();
	}
	...
	private void createModemBeans(List<SerialModemGateway> gateways){
		detectedModems = new ArrayList<Modem>();
		for(SerialModemGateway gateway: gateways){
			getDetectedModemBeans().add(new Modem(gateway));
		}
	}
	
	public List<Modem> updateModemBeans(){
		...
		List<Modem> toRemove = new ArrayList<Modem>();
		//first, remove any gateways that are no longer there
		for(Modem modem: getDetectedModemBeans()){
	 ...
	 */
	public List<Modem> getDetectedModemBeans(){
