...
<div class="conversationBox">
    <div class="boxHeader">
        ...
        <img id="refreshButton" class="align-right"
             src="<openmrs:contextPath/>/moduleResources/messaging/images/refresh.png" onclick="fillMessageList()"/>
    </div>
    <div class="box">
        <div class="message-list" id="messageList">
            <div class="to-message-row" id="messagePattern" style="display:none" onmouseover="handleMouseOver(this.id)"
                 onmouseout="handleMouseOut(this.id)">
                ...
                <td>
                    <select id="protocolName">
                        <c:forEach var="protocol" items="${protocols}">
                            <option value="${protocol.protocolName}">${protocol.protocolName}</option>
                        </c:forEach>
                    </select>
                </td>
                <td>Address</td>
...
<script type="text/javascript">
    ...
    function fillAddressesTable() {
        ...
        DWRMessagingAddressService.getAllAddressesForPersonId(${patient.patientId}, function (addresses) {
            ...
            dwr.util.removeAllRows("addressbody", { filter: function (tr) {
            ...
            if (addresses != null) {
                for (var i = 0; i < addresses.length; i++) {
                    ...
                    dwr.util.setValue("tableType" + id, address.protocolClass.substring(address.protocolClass.lastIndexOf(".") + 1).replace("Protocol", ""));
    ...
    function writeAddress() {
        var address = { messagingAddressId: viewed, protocolClass: null, address: null, preferred: null, dateCreated: null };
    ...
    function fillMessageList() {
        $("refreshButton").src = "<openmrs:contextPath/>/moduleResources/messaging/images/ajax-loader.gif";
