...
public class SettingsController {
	...
	public void populateModel(HttpServletRequest request){
		...
		PersonAttribute shouldAlertAttr = attributeService.getPersonAttribute(p,personService.getPersonAttributeTypeByName(MessagingConstants.SEND_OMAIL_ALERTS_ATTR_NAME));
		...
		PersonAttribute alertAddressAttr = attributeService.getPersonAttribute(p,personService.getPersonAttributeTypeByName(MessagingConstants.ALERT_ADDRESS_ATTR_NAME));
